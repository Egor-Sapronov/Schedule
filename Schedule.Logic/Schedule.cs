...
namespace Schedule.Logic
{
    ...
    {
        private static CodeFunctor _workPeriodAssignmentFunctor = new CodeFunctor("workPeriodAssignment", 2);
        private static CodeFunctor _workPeriodFunctor = new CodeFunctor("workPeriod", 2);

        private ScheduleDay _monday = new ScheduleDay();
        private ScheduleDay _tuesday = new ScheduleDay();
        private ScheduleDay _wednesday = new ScheduleDay();
        private ScheduleDay _thursday = new ScheduleDay();
        private ScheduleDay _friday = new ScheduleDay();

        public ScheduleDay Monday { get { return _monday; } }
        public ScheduleDay Tuesday { get { return _tuesday; } }
        public ScheduleDay Wednesday { get { return _wednesday; } }
        public ScheduleDay Thursday { get { return _thursday; } }
        public ScheduleDay Friday { get { return _friday; } }
